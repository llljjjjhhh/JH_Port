...
## Tech 4
스폰된 메시 파티클이 바라보는 방향으로 포지션을 Update할 수 있는 모듈 테스트
 - 메시가 회전된 방향(쿼터니언)으로 축 벡터를 회전시켜서 forward 벡터를 획득
### Tech Demo
https://github.com/user-attachments/assets/9c166b11-c20f-4a17-aedc-3fa8fbfb81cc

<img width="1964" height="734" alt="쿼터니언" src="https://github.com/user-attachments/assets/fbccb81b-48d1-4001-8a9b-ee22b5711c6b" />
...
## Tech 10
오버드로우 최적화
 - 메시 렌더를 활용하여 텍스쳐의 빈 공간 때문에 낭비하는 드로우를 제거

https://github.com/user-attachments/assets/25d92863-3e01-41a3-93a6-2dd4a084f86a
